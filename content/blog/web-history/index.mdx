...
<dl class="framework-list">
  <div class="framework-list__item">
    <dt><Icon name="devicon:backbonejs" size={20} /> Backbone <span>2010</span></dt>
    <dd>Introduced structure with models, views, and routers — one of the first serious attempts at building SPAs.</dd>
  </div>
  <div class="framework-list__item">
    <dt><Icon name="devicon:angularjs" size={20} /> Angular <span>2010</span></dt>
    <dd>Google’s all-in-one tool: two-way data binding, dependency injection, and custom directives. Powerful but heavy.</dd>
  </div>
  <div class="framework-list__item">
    <dt><Icon name="devicon:ember" size={20} /> Ember <span>2011</span></dt>
    <dd>Focused on convention over configuration. Great for large apps and teams, but not lightweight or flexible.</dd>
  </div>
  <div class="framework-list__item">
    <dt><Icon name="devicon:react" size={20} /> React <span>2013</span></dt>
    <dd>Changed everything with components and a virtual DOM. Emphasized UI as a function of state.</dd>
  </div>
  <div class="framework-list__item">
    <dt><Icon name="devicon:vuejs" size={20} /> Vue <span>2014</span></dt>
    <dd>Combined the best ideas from Angular and React with a smoother learning curve and optional complexity.</dd>
  </div>
  <div class="framework-list__item">
    <dt><Icon name="devicon:angular" size={20} /> Angular 2 <span>2016</span></dt>
    <dd>A full rewrite of AngularJS. TypeScript-first, modular, and better suited for modern enterprise apps.</dd>
  </div>
  <div class="framework-list__item">
    <dt><Icon name="devicon:svelte" size={20} /> Svelte <span>2016</span></dt>
    <dd>Compiles components into minimal JavaScript. No virtual DOM — just fast, efficient DOM updates.</dd>
  </div>
  <div class="framework-list__item">
    <dt><Icon name="devicon:solidjs" size={20} /> Solid <span>2018</span></dt>
    <dd>Like React but with fine-grained reactivity and no virtual DOM. Insanely fast and super small.</dd>
  </div>
</dl>
...
<style>{`
  ...
  .framework-list__item:first-child {
