...
Our brains does this automatically, and we don't even realize it's happening. For example, when we look at a picture, our brains automatically identify the main subject *(the figure)* and separate it from the background *(the ground)*. 
